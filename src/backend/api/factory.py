...
def create_app(
    ...
    e dados de contato com os executores recebidos; ausências permanecem
    explícitas e são traduzidas por cada router em indisponibilidade. Ela
    existe para concentrar a composição na camada externa, mantendo
