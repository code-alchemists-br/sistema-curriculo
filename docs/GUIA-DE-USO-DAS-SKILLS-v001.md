...
Ao analisar um problema comece por usar `$decision-analysis-v4` para verificar se o problema pode ser decomposto em partes menores que possam ser mais facilmente revisadas por humanos. Usem tais partes para gerar análises e prompts estruturados menores.
